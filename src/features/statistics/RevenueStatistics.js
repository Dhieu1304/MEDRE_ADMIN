                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <Typography sx={{ textAlign: "right" }} variant="subtitle1">
                          {t("table.col.totalOff")}
                        </Typography>
                      </TableCell>
                      <TableCell>
                        <Typography sx={{ textAlign: "right" }} variant="subtitle1">
                          {t("table.col.totalOnl")}
                        </Typography>
                      </TableCell>
                    </TableRow>
                  </TableHead>
                    ...
                    {data?.map((item) => {
                      return (
                        <TableRow key={item?.time}>
                          ...
                          <TableCell sx={{ textAlign: "right" }}>{formatCurrency(item?.totalOnl || 0)}</TableCell>
                          <TableCell sx={{ textAlign: "right" }}>{formatCurrency(item?.totalOff || 0)}</TableCell>
                        </TableRow>
                      );
                    })}
                  </TableBody>
